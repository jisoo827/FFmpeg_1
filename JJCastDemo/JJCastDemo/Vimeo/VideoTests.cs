...
{
    public class VideoTests : BaseHelper
    {
        ...
        public async Task ShouldMoveVideoToFolder()
        {
            await AuthenticatedClient.UnassignEmbedPresetFromVideoAsync(VimeoSettings.PublicVideoId, VimeoSettings.EmbedPresetId);
        }
    }
}
