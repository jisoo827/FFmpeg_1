...
namespace FFMPEGTest1.FFmpeg.Decoder
{
    public sealed unsafe class VideoFrameConverterCam : IDisposable
    {
        ...
        public VideoFrameConverterCam(Size sourceSize, AVPixelFormat sourcePixelFormat,
